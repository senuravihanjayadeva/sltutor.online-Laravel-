...
<div class="container profile profile-view" id="profile">
    ...
    {!! Form::open(['action' => 'PastPapersController@store', 'method' => 'POST','enctype' => 'multipart/form-data']) !!}
        ...
        <div class="form-row profile-row">
            ...
            <div class="col-md-8">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('grade', [
                                ...
                                ], null,['class' => 'form-control' , 'placeholder' => 'Pick a grade...']) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('term', [
                        ...
                        ], null,['class' => 'form-control' , 'placeholder' => 'Pick a term...']) }}
            ...
            <div class="form-group">
                    ...
                    {{ Form::select('medium', [
                        ...
                        ], null,['class' => 'form-control' , 'placeholder' => 'Pick a Medium...']) }}
